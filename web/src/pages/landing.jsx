  ...
  return (
    <div className="flex flex-col items-center justify-center h-1/2">
      <div className="p-5 bg-white rounded-2xl">
        <MessageCircle className="text-black size-15"></MessageCircle>
      </div>
      <p className="text-3xl font-bold m-4 text-center">Discord Message Automation Tool</p>
      <p className="text-1xl text-neutral-500 mb-7 text-center">Automate sending hiring posts on commission boards, <br/> sharing new social media posts, and more!</p>
